...
"Platsspecifika webbläsare":http://en.wikipedia.org/wiki/Site-specific_browser kallas lösningen på problemet och till Macen har vi Mozillas "Prism":http://prism.mozilla.com och Todd Ditchendorfs "Fluid":http://fluidapp.com att välja på. Dessa program hjälper dig att skapa en skrivbordsapplikation av valfri webbsida. Fluid och Prism är ganska likvärdiga i funktionalitet men bygger på olika renderingsmotorer - WebKit respektive Gecko.
...
Om man "googlar":http://www.google.com/search?q=fluid+OR+prism+icons lite är det inte svårt att hitta "läckra ikoner":http://www.flickr.com/groups/fluid_icons/pool/ till sitt favoritprogram.