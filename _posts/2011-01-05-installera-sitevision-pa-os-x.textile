...
<pre><code class="bash">$ cd /Users/Sven/Downloads
...
<pre><code class="bash">$ cd /Users/Sven/sitevision
...
<pre><code class="bash">$ cp custom/conf/linux.properties custom/conf/mac.properties</code></pre>

Öppna _mac.properties_ i en textredigerare och ändra sökvägarna till din SiteVision-installation.

<pre><code class="bash">$ nano custom/conf/mac.properties</code></pre>

<pre><code class="bash"># Location of /data
...
<pre><code class="bash">$ nano custom/conf/service/sitevision_linux.conf</code></pre>

<pre><code class="bash">wrapper.java.additional.4=-Djava.io.tmpdir=/Users/Sven/sitevision/data/temp</code></pre>

h2. Starta upp SiteVision

Installationen är färdig - nu är det bara att starta upp SiteVision.

<pre><code class="bash">$ cd /Users/Sven/sitevision/bin
